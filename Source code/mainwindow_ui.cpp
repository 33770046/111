...
MainWindow::MainWindow(QWidget* parent)
    ...
    fileMenu(nullptr), mainLayout(nullptr)
{
...
void MainWindow::showAboutDialog()
{
    ...
    rotatedPixmap = rotatedPixmap.scaled(150, 396, Qt::KeepAspectRatio);

    // 设置图片和文本布局
    aboutBox.setIconPixmap(rotatedPixmap);
    aboutBox.setText(
        "<h2>智能分组系统</h2>"
        "<p>版本 251007.1800</p>"
        "<p>作者 3377004_6</p>"
        ...
        "<p><a href='https://github.com/33770046/111'>前往更新</a></p>"
    );
    aboutBox.exec();
}
