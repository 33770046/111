...
private slots:
    ...
    void manualUpdateCheck(bool silent);
...
private:
    ...
    void onUpdateCheckFinished(bool silent, QNetworkReply* reply);
    void showUpdateDialog(const QString& latestVersion, const QString& downloadUrl, const QString& releaseNotes);
